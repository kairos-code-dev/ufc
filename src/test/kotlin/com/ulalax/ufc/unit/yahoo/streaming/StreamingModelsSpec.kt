...
class StreamingModelsSpec : UnitTestBase() {
    ...
    fun `MarketHours fromCode converts correctly`() =
        unitTest {
            // Then
    ...
    fun `QuoteType fromCode converts correctly`() =
        unitTest {
            // Then
    ...
    fun `ReconnectionConfig calculates delay correctly`() =
        unitTest {
            // Given
            val config =
                ReconnectionConfig(
    ...
    fun `StreamingClientConfig has correct defaults`() =
        unitTest {
            // When
    ...
    fun `PricingData deserializes from Protobuf`() =
        unitTest {
    ...
    fun `StreamingPrice is constructed correctly`() =
        unitTest {
            // When
            val price =
                StreamingPrice(
    ...
    fun `StreamingQuote is constructed correctly`() =
        unitTest {
            // When
            val quote =
                StreamingQuote(
    ...
    fun `StreamingPrice nullable fields accept null`() =
        unitTest {
            // When
            val price =
                StreamingPrice(
    ...
    fun `StreamingQuote nullable fields accept null`() =
        unitTest {
            // When
            val quote =
                StreamingQuote(
