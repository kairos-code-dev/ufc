...
class OptionsSpec : IntegrationTestBase() {
    ...
    inner class BasicBehavior {
        ...
        fun `returns options chain for AAPL`() =
            integrationTest(
        ...
        fun `returns options chain for specific expiration date`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
    ...
    inner class ResponseSpec {
        ...
        fun `options chain contains calls and puts`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `option contract contains required fields`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `includes underlying quote information`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `includes expiration dates and strikes list`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
    ...
    inner class DataAccessExamples {
        ...
        fun `can find call option by strike`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `can find put option by strike`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `can filter in-the-money options`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `can filter out-of-the-money options`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
    ...
    inner class UtilityMethods {
        ...
        fun `can find nearest strike price`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `can find at-the-money options`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `can convert expiration dates to LocalDate`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
    ...
    inner class UsageExamples {
        ...
        fun `can fetch TSLA options chain`() =
            integrationTest {
                // Given
        ...
        fun `can fetch options via Ufc facade`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
    ...
    inner class ErrorCases {
        ...
        fun `handles invalid symbol gracefully`() =
            integrationTest {
                // Given
        ...
        fun `returns empty options chain for invalid expiration date`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
