...
class QuoteSpec : IntegrationTestBase() {
    @Test
    fun `returns quote data for AAPL`() =
        integrationTest {
            // given
            val symbol = "AAPL"
    ...
    @Test
    fun `returns quote data for multiple symbols`() =
        integrationTest {
            // given
    ...
    @Test
    fun `returns quote data with core market fields for AAPL`() =
        integrationTest {
            // given
            val symbol = "AAPL"
    ...
    @Test
    fun `returns ETF quote data for SPY`() =
        integrationTest {
            // given
            val symbol = "SPY"
