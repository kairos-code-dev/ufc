...
class ChartSpec : IntegrationTestBase() {
    ...
    inner class BasicBehavior {
        ...
        fun `returns chart data for AAPL with 1 year period`() =
            integrationTest(
        ...
        fun `returns hourly chart data for MSFT with 1 month period`() =
            integrationTest {
                // Given
    ...
    inner class ResponseSpec {
        ...
        fun `chart data contains OHLCV information`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val interval = Interval.OneDay
        ...
        fun `chart metadata contains symbol and currency`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val interval = Interval.OneDay
    ...
    inner class EventsSpec {
        ...
        fun `can fetch both dividends and splits at once`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val interval = Interval.OneDay
    ...
    inner class DataAccessExamples {
        ...
        fun `can extract OHLCV data from chart`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val interval = Interval.OneDay
        ...
        fun `can get symbol currency and exchange from metadata`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val interval = Interval.OneDay
        ...
        fun `can extract dividend events`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val interval = Interval.OneDay
        ...
        fun `can use OHLCV helper methods`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val interval = Interval.OneDay
    ...
    inner class UsageExamples {
        ...
        fun `can fetch cryptocurrency chart data`() =
            integrationTest {
                // Given
