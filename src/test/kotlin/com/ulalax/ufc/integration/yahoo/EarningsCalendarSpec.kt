...
class EarningsCalendarSpec : IntegrationTestBase() {
    ...
    inner class BasicBehavior {
        ...
        fun `returns earnings calendar for AAPL with default limit`() =
            integrationTest {
                // Given
        ...
        fun `returns earnings calendar for MSFT with custom limit`() =
            integrationTest {
                // Given
        ...
        fun `returns historical earnings with offset`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val offset = 1
    ...
    inner class EventFiltering {
        ...
        fun `filters historical and future events`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `returns next earnings event`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
        ...
        fun `returns latest historical earnings`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
    ...
    inner class SurpriseAnalysis {
        ...
        fun `analyzes earnings surprises`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
    ...
    inner class EdgeCases {
        ...
        fun `returns empty result for large offset`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val offset = 1000
        ...
        fun `returns result with minimum limit`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val limit = 1
        ...
        fun `returns result with maximum limit`() =
            integrationTest {
                // Given
                val symbol = TestFixtures.Symbols.AAPL
                val limit = 100
