...
class LookupSpec : IntegrationTestBase() {
    ...
    inner class BasicBehavior {
        ...
        fun `returns results including AAPL when searching for Apple`() =
            integrationTest {
                // Given
                val query = "Apple"
        ...
        fun `returns up to 25 results by default`() =
            integrationTest {
                // Given
                val query = "tech"
        ...
        fun `all results contain required symbol and name fields`() =
            integrationTest {
                // Given
                val query = "Microsoft"
    ...
    inner class TypeFiltering {
        ...
        fun `returns only equities when filtering by EQUITY type`() =
            integrationTest {
                // Given
                val query = "Apple"
        ...
        fun `returns only ETFs when filtering by ETF type`() =
            integrationTest {
                // Given
                val query = "SPY"
        ...
        fun `returns all types of securities when using ALL type`() =
            integrationTest {
                // Given
                val query = "Bitcoin"
    ...
    inner class CountControl {
        ...
        fun `can limit results with count parameter`() =
            integrationTest {
                // Given
                val query = "tech"
                val count = 10
        ...
        fun `returns at most 1 result when count is 1`() =
            integrationTest {
                // Given
                val query = "Apple"
                val count = 1
    ...
    inner class EmptyResults {
        ...
        fun `returns valid results for non-existent query`() =
            integrationTest {
                // Given
        ...
        fun `always returns valid LookupResult`() =
            integrationTest {
                // Given
                val query = "any"
    ...
    inner class ParameterValidation {
        ...
        fun `throws INVALID_PARAMETER exception for empty query`() =
            integrationTest {
                // Given
                val query = ""
        ...
        fun `throws INVALID_PARAMETER exception for whitespace-only query`() =
            integrationTest {
                // Given
                val query = "   "
        ...
        fun `throws INVALID_PARAMETER exception when count is zero or negative`() =
            integrationTest {
                // Given
                val query = "Apple"
                val count = 0
        ...
        fun `throws INVALID_PARAMETER exception when count exceeds 100`() =
            integrationTest {
                // Given
                val query = "Apple"
                val count = 101
    ...
    inner class UfcFacadeIntegration {
        ...
        fun `can search using Ufc facade`() =
            integrationTest {
                // Given
                val query = "Tesla"
        ...
        fun `type filtering works through Ufc facade`() =
            integrationTest {
                // Given
                val query = "Amazon"
                val type = LookupType.EQUITY
