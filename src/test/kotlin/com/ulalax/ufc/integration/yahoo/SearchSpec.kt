...
class SearchSpec : IntegrationTestBase() {
    ...
    inner class BasicBehavior {
        ...
        fun `returns AAPL when searching for Apple`() =
            integrationTest(
        ...
        fun `returns AAPL as first result when searching exact symbol`() =
            integrationTest {
                // Given
                val query = "AAPL"
    ...
    inner class ResponseSpec {
        ...
        fun `quote results contain required fields`() =
            integrationTest {
                // Given
                val query = "AAPL"
        ...
        fun `news results contain required fields`() =
            integrationTest {
                // Given
                val query = "Apple"
    ...
    inner class SearchOptions {
        ...
        fun `can enable fuzzy query for typo correction`() =
            integrationTest {
                // Given
                val query = "Appel" // 오타
    ...
    inner class EdgeCases {
        ...
        fun `returns empty results for non-existent query`() =
            integrationTest {
                // Given
        ...
        fun `returns empty lists when count is zero`() =
            integrationTest {
                // Given
                val query = "Apple"
    ...
    inner class RealWorldUseCases {
        ...
        fun `can search multi-country stocks like Samsung`() =
            integrationTest {
                // Given
                val query = "Samsung"
