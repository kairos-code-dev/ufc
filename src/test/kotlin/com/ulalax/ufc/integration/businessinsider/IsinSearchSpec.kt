...
class IsinSearchSpec : IntegrationTestBase() {
    ...
    inner class BasicBehavior {
        ...
        fun `returns result for Apple ISIN`() =
            integrationTest(
        ...
        fun `returns result for Microsoft ISIN`() =
            integrationTest {
                // Given
        ...
        fun `returns result for Samsung Korea ISIN`() =
            integrationTest {
                // Given
    ...
    inner class ResponseSpec {
        ...
        fun `result contains isin symbol and name`() =
            integrationTest {
                // Given
        ...
        fun `result ISIN matches requested ISIN`() =
            integrationTest {
                // Given
    ...
    inner class IsinFormat {
        ...
        fun `US stock ISIN starts with US`() =
            integrationTest {
                val usIsins =
                    listOf(
                        "US0378331005", // Apple
        ...
        fun `Korean stock ISIN starts with KR`() =
            integrationTest {
                // KR7005930003: 삼성전자
        ...
        fun `Japanese stock ISIN starts with JP`() =
            integrationTest {
    ...
    inner class DataAccessExamples {
        ...
        fun `can get symbol, isin, and name from result`() =
            integrationTest {
        ...
        fun `can get exchange and currency from result`() =
            integrationTest {
                val result = ufc.businessInsider.searchIsin("US0378331005")
        ...
        fun `can get security type from result`() =
            integrationTest {
                val result = ufc.businessInsider.searchIsin("US0378331005")
        ...
        fun `symbol from ISIN search can be used with Yahoo Finance API`() =
            integrationTest {
                // 1. ISIN으로 심볼 검색
    ...
    inner class UsageExamples {
        ...
        fun `can search Japanese stock ISIN`() =
            integrationTest {
                // Given
        ...
        fun `can convert ISIN to Yahoo Finance symbol`() =
            integrationTest {
                // Given
                val isin = TestFixtures.Isin.APPLE
    ...
    inner class ValidationSpec {
        ...
        fun `throws ValidationException for invalid ISIN format`() =
            integrationTest {
                // Given - 12자리가 아닌 ISIN
        ...
        fun `throws ValidationException for empty ISIN`() =
            integrationTest {
                // Given
                val emptyIsin = ""
    ...
    inner class ErrorCases {
        ...
        fun `throws NoSuchElementException for non-existent ISIN`() =
            integrationTest {
