...
class FredSeriesSpec : IntegrationTestBase() {
    ...
    inner class BasicBehavior {
        ...
        fun `returns unemployment rate series data`() = integrationTest {
            // Given
    ...
    inner class ResponseSpec {
        ...
        fun `series info contains id title frequency and units`() = integrationTest {
            // Given
            val seriesId = TestFixtures.FredSeries.GDP
        ...
        fun `observations contain date and value`() = integrationTest {
            // Given
            val seriesId = TestFixtures.FredSeries.GDP
        ...
        fun `observations are sorted by date`() = integrationTest {
            // Given
            val seriesId = TestFixtures.FredSeries.UNEMPLOYMENT
    ...
    inner class DateRangeSpec {
        ...
        fun `can fetch data with specific date range`() = integrationTest {
            // Given
            val seriesId = TestFixtures.FredSeries.GDP
        ...
        fun `can fetch recent one year data`() = integrationTest {
            // Given
            val seriesId = TestFixtures.FredSeries.UNEMPLOYMENT
    ...
    inner class PopularSeries {
        ...
        fun `GDP series - US Gross Domestic Product`() = integrationTest {
        ...
        fun `UNRATE series - US Unemployment Rate`() = integrationTest {
        ...
        fun `FEDFUNDS series - Federal Funds Rate`() = integrationTest {
        ...
        fun `DGS10 series - 10 Year Treasury Rate`() = integrationTest {
        ...
        fun `CPIAUCSL series - Consumer Price Index`() = integrationTest {
    ...
    inner class DataAccessExamples {
        ...
        fun `can access series metadata`() = integrationTest {
            val result = ufc.fred!!.series("GDP")
        ...
        fun `can extract date and value from observations`() = integrationTest {
            val result = ufc.fred!!.series("UNRATE")
        ...
        fun `can filter by date range`() = integrationTest {
    ...
    inner class UsageExamples {
        ...
        fun `can fetch federal funds rate`() = integrationTest {
            // Given
        ...
        fun `can fetch 10 year treasury rate`() = integrationTest {
            // Given
    ...
    inner class ErrorCases {
        ...
        fun `throws exception for invalid series id`() = integrationTest {
            // Given
