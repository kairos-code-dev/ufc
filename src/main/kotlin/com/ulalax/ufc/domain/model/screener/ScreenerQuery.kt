...
class EquityQuery(
    ...
    companion object {
         ...
         * AND 조건 생성
         */
        fun and(vararg queries: EquityQuery): EquityQuery = EquityQuery(ScreenerOperator.AND, queries.toList())

        /**
         * OR 조건 생성
         */
        fun or(vararg queries: EquityQuery): EquityQuery = EquityQuery(ScreenerOperator.OR, queries.toList())
        ...
        fun eq(
            field: EquityField,
            value: Any,
        ): EquityQuery = EquityQuery(ScreenerOperator.EQ, listOf(field.apiValue, value))
        ...
        fun gt(
            field: EquityField,
            value: Number,
        ): EquityQuery = EquityQuery(ScreenerOperator.GT, listOf(field.apiValue, value))
        ...
        fun lt(
            field: EquityField,
            value: Number,
        ): EquityQuery = EquityQuery(ScreenerOperator.LT, listOf(field.apiValue, value))
        ...
        fun gte(
            field: EquityField,
            value: Number,
        ): EquityQuery = EquityQuery(ScreenerOperator.GTE, listOf(field.apiValue, value))
        ...
        fun lte(
            field: EquityField,
            value: Number,
        ): EquityQuery = EquityQuery(ScreenerOperator.LTE, listOf(field.apiValue, value))
        ...
        fun between(
            ...
            min: Number,
            max: Number,
        ): EquityQuery = EquityQuery(ScreenerOperator.BTWN, listOf(field.apiValue, min, max))
...
class FundQuery(
    ...
    companion object {
         ...
         * AND 조건 생성
         */
        fun and(vararg queries: FundQuery): FundQuery = FundQuery(ScreenerOperator.AND, queries.toList())

        /**
         * OR 조건 생성
         */
        fun or(vararg queries: FundQuery): FundQuery = FundQuery(ScreenerOperator.OR, queries.toList())
        ...
        fun eq(
            field: FundField,
            value: Any,
        ): FundQuery = FundQuery(ScreenerOperator.EQ, listOf(field.apiValue, value))
        ...
        fun gt(
            field: FundField,
            value: Number,
        ): FundQuery = FundQuery(ScreenerOperator.GT, listOf(field.apiValue, value))
        ...
        fun lt(
            field: FundField,
            value: Number,
        ): FundQuery = FundQuery(ScreenerOperator.LT, listOf(field.apiValue, value))
        ...
        fun gte(
            field: FundField,
            value: Number,
        ): FundQuery = FundQuery(ScreenerOperator.GTE, listOf(field.apiValue, value))
        ...
        fun lte(
            field: FundField,
            value: Number,
        ): FundQuery = FundQuery(ScreenerOperator.LTE, listOf(field.apiValue, value))
        ...
        fun between(
            ...
            min: Number,
            max: Number,
        ): FundQuery = FundQuery(ScreenerOperator.BTWN, listOf(field.apiValue, min, max))
