package com.ulalax.ufc.yahoo.internal.response
 ...
 */
@Serializable
internal data class SummaryProfile(
    @SerialName("sector")
    val sector: String? = null,
    @SerialName("industry")
    val industry: String? = null,
 ...
 */
@Serializable
internal data class TopHoldings(
 ...
 */
@Serializable
internal data class EquityHoldings(
 ...
 */
@Serializable
internal data class FundProfile(
