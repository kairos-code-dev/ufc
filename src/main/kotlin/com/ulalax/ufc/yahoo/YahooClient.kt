package com.ulalax.ufc.yahoo

import com.ulalax.ufc.common.exception.ApiException
import com.ulalax.ufc.common.exception.DataParsingException
import com.ulalax.ufc.common.exception.ErrorCode
import com.ulalax.ufc.common.ratelimit.GlobalRateLimiters
import com.ulalax.ufc.common.ratelimit.RateLimiter
import com.ulalax.ufc.yahoo.internal.YahooApiUrls
import com.ulalax.ufc.yahoo.internal.auth.YahooAuthenticator
import com.ulalax.ufc.yahoo.internal.response.ChartDataResponse
import com.ulalax.ufc.yahoo.internal.response.QuoteSummaryResponse
...
class YahooClient internal constructor(
    ...
    private fun convertToQuoteSummaryModuleResult(
        result: com.ulalax.ufc.yahoo.internal.response.QuoteSummaryResult,
    ...
    private fun convertRawFormatted(internal: com.ulalax.ufc.yahoo.internal.response.RawFormatted): RawFormatted {
        return RawFormatted(raw = internal.raw, fmt = internal.fmt)
    }

    private fun convertPrice(internal: com.ulalax.ufc.yahoo.internal.response.Price): Price {
        return Price(
    ...
    private fun convertSummaryDetail(internal: com.ulalax.ufc.yahoo.internal.response.SummaryDetail): SummaryDetail {
    ...
    private fun convertFinancialData(internal: com.ulalax.ufc.yahoo.internal.response.FinancialData): FinancialData {
    ...
    private fun convertEarningsTrendData(internal: com.ulalax.ufc.yahoo.internal.response.EarningsTrendData): EarningsTrendData {
    ...
    private fun convertEarningsTrend(internal: com.ulalax.ufc.yahoo.internal.response.EarningsTrend): EarningsTrend {
    ...
    private fun convertEarningsHistory(internal: com.ulalax.ufc.yahoo.internal.response.EarningsHistory): EarningsHistory {
    ...
    private fun convertEarningsDates(internal: com.ulalax.ufc.yahoo.internal.response.EarningsDates): EarningsDates {
    ...
    private fun convertHolder(internal: com.ulalax.ufc.yahoo.internal.response.Holder): Holder {
        return Holder(
            maxAge = internal.maxAge,
    ...
    private fun convertMajorHolders(internal: com.ulalax.ufc.yahoo.internal.response.MajorHolders): MajorHolders {
        return MajorHolders(
            maxAge = internal.maxAge,
    ...
    private fun convertInsiderTransaction(internal: com.ulalax.ufc.yahoo.internal.response.InsiderTransaction): InsiderTransaction {
    ...
    private fun convertInsiderTransactions(internal: com.ulalax.ufc.yahoo.internal.response.InsiderTransactions): InsiderTransactions {
    ...
    private fun convertQuoteType(internal: com.ulalax.ufc.yahoo.internal.response.QuoteType): QuoteType {
        return QuoteType(
            exchange = internal.exchange,
    ...
    private fun convertAssetProfile(internal: com.ulalax.ufc.yahoo.internal.response.AssetProfile): AssetProfile {
        return AssetProfile(
            sector = internal.sector,
            industry = internal.industry,
    ...
    private fun convertSummaryProfile(internal: com.ulalax.ufc.yahoo.internal.response.SummaryProfile): SummaryProfile {
    ...
    private fun convertDefaultKeyStatistics(internal: com.ulalax.ufc.yahoo.internal.response.DefaultKeyStatistics): DefaultKeyStatistics {
    ...
    private fun convertHolding(internal: com.ulalax.ufc.yahoo.internal.response.Holding): Holding {
        return Holding(
            symbol = internal.symbol,
            name = internal.name,
    ...
    private fun convertEquityHoldings(internal: com.ulalax.ufc.yahoo.internal.response.EquityHoldings): EquityHoldings {
    ...
    private fun convertBondHoldings(internal: com.ulalax.ufc.yahoo.internal.response.BondHoldings): BondHoldings {
        return BondHoldings(
    ...
    private fun convertSectorWeighting(internal: com.ulalax.ufc.yahoo.internal.response.SectorWeighting): SectorWeighting {
    ...
    private fun convertTopHoldings(internal: com.ulalax.ufc.yahoo.internal.response.TopHoldings): TopHoldings {
        return TopHoldings(
    ...
    private fun convertFeesExpenses(internal: com.ulalax.ufc.yahoo.internal.response.FeesExpenses): FeesExpenses {
        return FeesExpenses(
    ...
    private fun convertFundProfile(internal: com.ulalax.ufc.yahoo.internal.response.FundProfile): FundProfile {
        return FundProfile(
    ...
    private fun convertToChartData(
        chartResult: com.ulalax.ufc.yahoo.internal.response.ChartResult,
