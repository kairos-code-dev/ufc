 ...
 * println("${spy.symbol} (${spy.quoteType})")
 * println("Top Holdings: ${spy.topHoldings.size} stocks")
 *
 * // 펀드 여부 확인
 * val isFund = ufc.funds.isFund("SPY")  // true
 * val isStock = ufc.funds.isFund("AAPL")  // false
 * ```
 */
interface FundsApi {
     ...
     * @throws UfcException 모든 조회가 실패한 경우
     */
